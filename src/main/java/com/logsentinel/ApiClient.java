...
public class ApiClient {
    ...
    private String basePath = "https://api.logsentinel.com";
    ...
    public ApiClient() {
        ...
        setUserAgent("LogSentinel-Client/0.0.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://logsentinel.com/
